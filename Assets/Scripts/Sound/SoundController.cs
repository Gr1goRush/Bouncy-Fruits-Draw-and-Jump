...
public class SoundController : MonoBehaviour
{
    ...
    [SerializeField] private GameObject[] _vibrationButtons;
    ...
    {
        _vibrationInfo = 1 - _vibrationInfo;
        PlayerPrefs.SetInt("VibrationInfo", _vibrationInfo);
        ApplySettings(_vibrationInfo, _vibrationButtons);
        _audioSource.PlayOneShot(_buttonSound);
    }
    ...
    private void Initialize()
    {
        ...
        _vibrationInfo = PlayerPrefs.GetInt("VibrationInfo", 1);
